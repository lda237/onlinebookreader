@extends("layouts.admins")
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-header" style="background-color: #66c3ee; color:white">
              <h4 class="modal-title" id="exampleModallable">Add about</h4>
      ...
      <div class="modal" id="editmodalpop" data-toggle="modal"  tabindex="-1" role="dialog" aria-labelledby="exampleModallabel" aria-hidden="true" >
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <!-- Modal Header -->
            <div class="modal-header" style="background-color: #66c3ee; color:white">
              <h4 class="modal-title" id="exampleModallable">Edit about</h4>
     ...
     <div class="modal" id="deletemodalpop" tabindex="-1" role="dialog" aria-labelledby="exampleModallabel" aria-hidden="true" >
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <!-- Modal Header -->
            <div class="modal-header" style="background-color: #66c3ee; color:white">
              <h4 class="modal-title" id="">Delete about</h4>
              <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true" class="btn btn-danger">&times;</span> </button>
            </div>
            ...
            <div class="text-center modal-body">
                <!--<input type="text" id="about_id">-->
    <center><img src="{{asset('storage/sent.png')}}" alt="" width="50" height="46"></center>
                            <h3>Are you sure want to delete this about?</h3>
            </div>
    ...
    <div  style=" text-align: center;">
                    <h4> abouts</h4>
                      <button type="button" class="float-right btn" data-toggle="modal" data-target="#addModal" style="background-color: #66c3ee; color:white"><i class="fa fa-plus"> Add about</i></button>
    <br><br>
                  </div>
          <div class="card">
            <style>
    ...
    //taking the id of the about send it to the routre to delete
    $('#myTable').on('click', '.deletebtn', function(){
     $tr = $(this).closest('tr');
     var about = $tr.children('td').map(function(){
       return $(this).text();
     }).get();

    // console.log(about);

     $('#about_id').val(about[1]);
     $('#delete_modal_Form').attr('action', '/delete_about/'+about[1]);
     $('#deletemodalpop').modal('show');

      });

    //taking the id of the about send it to the routre to edit
    ...
    // console.log(about);
     ...
     $('#about_id').val(about[1]);
     $('#about_name').val(about[2]);
     $('#about_image').val(about[3]);
     $('#edit_modal_Form').attr('action', '/update_about/'+about[1]);
